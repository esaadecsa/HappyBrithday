...
const CONFIG = {
  ...
  // ulang tahun ("Us") dan dapat pengalaman penuh. Kalau salah / pilih
  // "Anonymous", dianggap pengunjung umum — link-nya sekarang cuma satu,
  // nggak perlu lagi ?to= yang beda-beda per orang.
  pin: "0000",
...
// siapa target vs siapa pengunjung umum dibedakan lewat layar PIN, bukan
// URL). ?date= tetap didukung kalau suatu saat kamu mau override tanggal
// tanpa edit kode.
...
$("#pinAnonBtn")?.addEventListener("click", () => {
  isTargetUser = false;
  playSfx("tap");
  showScreen("playlist");
});
