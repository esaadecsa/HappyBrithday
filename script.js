...
const screens = {
  ...
  nope: $("#nope"), candle: $("#candle"), flower: $("#flower-screen"), farewell: $("#farewell"), final: $("#final"), reaction: $("#reaction")
};
const SCREEN_ORDER = ["playlist", "minigame", "intro", "letter", "wish", "mood", "spirit", "memories", "polaroid", "gift", "candle", "flower", "farewell", "final", "reaction"];
...
document.addEventListener("keydown", (e) => {
  if (["ArrowRight", "Enter", " "].includes(e.key)) {
    if (["intro", "playlist", "letter", "wish", "memories", "polaroid", "flower", "farewell", "final"].includes(currentScreen)) { e.preventDefault(); primaryAction(); }
  }
...
document.addEventListener("touchend", (e) => {
  ...
  if (Math.abs(dx) > 60 && Math.abs(dx) > Math.abs(dy) * 1.5 && dx < 0) {
    if (["intro", "playlist", "letter", "wish", "memories", "polaroid", "flower", "farewell", "final"].includes(currentScreen)) primaryAction();
  }
}, { passive: true });
