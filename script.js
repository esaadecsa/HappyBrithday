...
const screens = {
  intro: $("#intro"), letter: $("#letter"), wish: $("#wish"), mood: $("#mood"), memories: $("#memories"), gift: $("#gift"),
  nope: $("#nope"), candle: $("#candle"), flower: $("#flower-screen"), final: $("#final")
};
const SCREEN_ORDER = ["intro", "letter", "wish", "mood", "memories", "gift", "candle", "flower", "final"];
...
$("#moodNextBtn").onclick = () => { playSfx("tap"); goMemories(); };
