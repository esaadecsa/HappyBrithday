...
const SEPTEMBER_ARRIVED = isSeptemberFirstWIB();
...
const CONFIG = {
  ...
  // ke slide sebelumnya). Isinya otomatis berganti khusus tanggal 1 September WIB saja.
  playlist: [
    SEPTEMBER_ARRIVED
      ? { id: "mainsong", title: "Panjang Umur", artist: "Chintya Gabriella", src: "./music/panjang-umur.mp3", hue: 350 }
      // GANTI title & artist di bawah sesuai lagu TikTok kamu:
      : { id: "mainsong", title: "Untouchable", artist: "Taylor Swift", src: "./music/countdown-song.mp3", hue: 210 },
...
/* ---------- MUSIK — satu elemen audio (music/pinMusic) yang sama dipakai
   ...
   (otomatis berganti khusus tanggal 1 September WIB, lihat SEPTEMBER_ARRIVED). ---------- */
