...
const screens = {
  intro: $("#intro"), letter: $("#letter"), wish: $("#wish"), mood: $("#mood"), memories: $("#memories"), polaroid: $("#polaroid"), gift: $("#gift"),
  nope: $("#nope"), candle: $("#candle"), flower: $("#flower-screen"), final: $("#final")
};
const SCREEN_ORDER = ["intro", "letter", "wish", "mood", "memories", "polaroid", "gift", "candle", "flower", "final"];
