...
const SCREEN_ORDER = ["playlist", "intro", "letter", "wish", "mood", "spirit", "memories", "polaroid", "minigame", "gift", "candle", "flower", "final"];
...
function primaryAction() {
  ...
  if (currentScreen === "playlist") return selectedSongIndex !== null && goIntro();
...
$("#playlistNextBtn").onclick = () => { if (selectedSongIndex === null) return; playSfx("tap"); goIntro(); };
